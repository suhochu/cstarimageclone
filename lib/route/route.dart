...
final routes = RouteMap(
  ...
  routes: {
    ...
    '/${HomeMain.routeName}': (route) => const NoAnimationPage(name: 'Welcome to CSTAR IMAGE', child: HomeMain()),
    '/${PersonalColorDiagnosisPage.routeName}': (route) => const NoAnimationPage(name: '퍼스널 컬러 진단', child: PersonalColorDiagnosisPage()),
    '/${ColorPsychologyConsultPage.routeName}': (route) => const NoAnimationPage(name: '색채심리상담(컬러테라피)', child: ColorPsychologyConsultPage()),
    ...
    '/${PurchasingTeachingToolPage.routeName}': (route) => const NoAnimationPage(name : '컬러교구 구입', child: PurchasingTeachingToolPage()),
